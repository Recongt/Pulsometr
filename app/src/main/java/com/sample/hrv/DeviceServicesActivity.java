...
import com.sample.hrv.wykresy.PulseDrawActivity;
...
public class DeviceServicesActivity extends Activity {
    ...
    public final BleServicesAdapter.OnServiceItemClickListener demoClickListener = new BleServicesAdapter.OnServiceItemClickListener() {
        @Override
